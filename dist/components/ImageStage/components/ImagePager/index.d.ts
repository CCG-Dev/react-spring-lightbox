...
declare const ImagePager: {
    ({ currentIndex, disableMouseWheel, images, imageStageHeight, imageStageWidth, inline, loadingComponent, onClose, onNext, onPrev, onZoomLevelChange, renderImageOverlay, showZoomIconsOnHover, singleClickToZoom, zoomLevel, }: IImagePager): React.JSX.Element;
    displayName: string;
};
